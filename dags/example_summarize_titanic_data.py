...
default_args={
    "owner": "edwardbunt@ebunt.ai,Open in Cloud IDE",
}

@dag(
    default_args=default_args,
    schedule=None,
    start_date=pendulum.from_format("2024-06-11", "YYYY-MM-DD"),
    catchup=False,
    owner_links={
        "edwardbunt@ebunt.ai": "mailto:edwardbunt@ebunt.ai",
        "Open in Cloud IDE": "https://cloud.astronomer.io/clxapnt7k0yum01j45ss9modo/cloud-ide/clxapxb6q0yqh01fi146opk9q/clxapxbca0yqi01fiyoi5bfkp",
    },
)
